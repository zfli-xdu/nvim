...
return packer.startup(function(use)
  ...
  -- telescope --
  use { "nvim-telescope/telescope.nvim" } -- requires rg(BurntSushi/ripgrep) installed for live_greps
  use { "nvim-telescope/telescope-media-files.nvim" } -- Extension: Previewer of images, pdf, and video, etc.
  use {
    "nvim-telescope/telescope-fzf-native.nvim",
    run = "cmake -S. -Bbuild -DCMAKE_BUILD_TYPE=Release && cmake --build build --config Release && cmake --install build --prefix build",
  } -- Extension: Native FZF sorter
